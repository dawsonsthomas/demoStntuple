...
//
///////////////////////////////////////////////////////////////////////////////
#ifndef heatherh_ana_TTrigAna001Module_hh
#define heatherh_ana_TTrigAna001Module_hh
...
class TTrigAna001Module: public TStnModule {
public:
...
//-----------------------------------------------------------------------------
  ...
  struct EventHist_t {
    ...
    TH1F*    fNTClHits[3];
    TH1F*    fCprDemTrigger[16];
    TH1F*    fTprDemTrigger[16];

    TH1F*    fCprDepTrigger[16];
    TH1F*    fTprDepTrigger[16];
    TH1F*    fThreshEffDem;
    TH1F*    fTPRnoneDem;
    TH1F*    fcalThreshNormDem;
    TH1F*    fThreshEffDep;
    TH1F*    fTPRnoneDep;
    TH1F*    fcalThreshNormDep;
    ...
    // TH1F*    fETot        [2];            // total energy/event 
    // TH2F*    fECrVsR      [2];            // total energy_per_crystal/event vs radius
    // TH2F*    fNCrVsR      [2];            // total energy_per_crystal/event vs radius

    // TH2F*    fNCrystalHitsVsR[2];            //
    // TH2F*    fNHitCrystalsVsR[2];            //
...
public:					// pointers to the data blocks used
  ...
  TStnTrackSeedBlock*  fCprDemTrackSeedBlock;
  TStnTrackSeedBlock*  fTprDemTrackSeedBlock;
  TStnTrackSeedBlock*  fCprDepTrackSeedBlock;
  TStnTrackSeedBlock*  fTprDepTrackSeedBlock;

  TStnHelixBlock*      fTprDemHelixBlock;
  TStnHelixBlock*      fTprDepHelixBlock;
  TStnHelixBlock*      fCprDemHelixBlock;
  TStnHelixBlock*      fCprDepHelixBlock;
  TStnHelixBlock*      fHelixBlock;

  TStnTrackBlock*      fTrackBlock;
  TStnTrackBlock*      fTprDemTrackBlock;
  TStnTrackBlock*      fCprDemTrackBlock;
  TStnTrackBlock*      fTprDepTrackBlock;
  TStnTrackBlock*      fCprDepTrackBlock;
  ...
  int               fMinTrigHelixNSh;

  int               fTrackHelixIndex;
  int               fTprTrackHelixIndex;
  int               fTrackDepHelixIndex;
  int               fTprDepTrackHelixIndex;
...
//-----------------------------------------------------------------------------
public:
  TTrigAna001Module(const char* name="TriggerAna", const char* title="TriggerAna");
  ~TTrigAna001Module();
//-----------------------------------------------------------------------------
// accessors
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
  ...
  void               SetBackgroundFlag(int Flag ) { fIsBackground  = Flag ; }
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
  ...
  void    FillTprDemTriggerHist(EventHist_t*   Hist, int &HasQualityTrack);
  void    FillCprDemTriggerHist(EventHist_t*   Hist, int &HasQaulityTrack);

  void    FillTprDepTriggerHist(EventHist_t*   Hist, int &HasQualityTrack);
  void    FillCprDepTriggerHist(EventHist_t*   Hist, int &HasQaulityTrack);
